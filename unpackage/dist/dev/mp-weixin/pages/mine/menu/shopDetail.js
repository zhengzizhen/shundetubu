...
var _shopDetail = _interopRequireDefault(__webpack_require__(/*! ./pages/mine/menu/shopDetail.vue */ 717));
// @ts-ignore
...
/* harmony import */ var _shopDetail_vue_vue_type_template_id_57163b58_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shopDetail.vue?vue&type=template&id=57163b58&scoped=true& */ 718);
/* harmony import */ var _shopDetail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shopDetail.vue?vue&type=script&lang=js& */ 720);
...
/* harmony import */ var _shopDetail_vue_vue_type_style_index_0_id_57163b58_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shopDetail.vue?vue&type=style&index=0&id=57163b58&lang=scss&scoped=true& */ 722);
  ...
  methods: {
    ...
    price: function price() {
      ...
      this.goods.sku.sku.forEach(function (item, index) {
        if (JSON.stringify(item.attr) === JSON.stringify(_this3.attr)) {
          _this3.runs = item;
          _this3.moeny = item.price;
          _this3.runs.price = _this3.moeny * _this3.num;
        }
      });
    },
        ...
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this4.$http('/shop/car/add', {
                  goods_id: _this4.id,
                  sku: _this4.attr,
                  number: _this4.num
                });
